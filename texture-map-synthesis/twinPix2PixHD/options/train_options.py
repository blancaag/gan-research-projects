...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # for the generator:
        self.parser.add_argument('--lambda_Gs_L1_z', type=float, default=0, help='weight for the L1 loss')
        # self.parser.add_argument('--lambda_Gs_L2_z', type=float, default=0, help='weight for the L1 loss')
        self.parser.add_argument('--lambda_Gs_cos_z', type=float, default=0, help='weight for the L1 loss')
        ...
        # for the classifier
        self.parser.add_argument('--class_loss', type=bool, default=True, help='weight for the L1 loss')
        self.parser.add_argument('--class_nc', type=int, default=3, help='weight for the L1 loss')
