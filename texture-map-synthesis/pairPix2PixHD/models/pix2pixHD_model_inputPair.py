...
class Pix2PixHDModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_G1 = torch.optim.Adam(params, lr=opt.lr, betas=(opt.beta1, 0.999))# amsgrad=True)
    ...
    def forward(self, label_1, label_2, inst, image_1, image_2, feat, infer=False):
        ...
        fake_image_2 = self.netG1.forward(input_concat_2)
        ...
        loss_G1_L1_z = self.criterionL1(self.netGE1(input_label_1), self.netGE1(input_label_2).detach()) * self.opt.lambda_Gs_L1_z
        loss_G2_L1_z = self.criterionL2(self.netGE1(input_label_2), self.netGE1(input_label_1).detach()) * self.opt.lambda_Gs_L1_z
        loss_G1_cos_z = self.criterionCos2(self.netGE1(input_label_1), self.netGE1(input_label_2).detach()) * self.opt.lambda_Gs_cos_z
        loss_G2_cos_z = self.criterionCos2(self.netGE1(input_label_2), self.netGE1(input_label_1).detach()) * self.opt.lambda_Gs_cos_z
